...
namespace DogApi.BLL
{
	...
	{
		private readonly DogApi.DAL.ActivityDao dal=new DogApi.DAL.ActivityDao();
		public ActivityBll()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<DogApi.Model.ActivityModel> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DogApi.Model.ActivityModel> DataTableToList(DataTable dt)
		{
			List<DogApi.Model.ActivityModel> modelList = new List<DogApi.Model.ActivityModel>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DogApi.Model.ActivityModel model;
